                        ...
                        <div class="row">
                            <div class="col-xl-6 col-xxl-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="legal_business_name"  value="{{ $user->name }}" class="form-control" required>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-xxl-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="checkbox" {{ old('is_there_additional_worksite') == 'on' ? 'checked' : '' }}  name="signed_all_documents" id="SamePlaceBusiness">&nbsp;&nbsp;{!! trans('employer.SamePlaceBusiness') !!}
                                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="main_worksite_location" value="{{old('main_worksite_location')}}" class="form-control"
                                        maxlength="200">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="main_worksite_city" value="{{old('main_worksite_city')}}" class="form-control"
                                                    maxlength="200">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="main_worksite_country" value="{{old('main_worksite_country')}}" class="form-control"
                                                    maxlength="200">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="main_worksite_zip_code" value="{{old('main_worksite_zip_code')}}" class="form-control"
                                                    data-inputmask="'mask': ['99999']" data-mask class="form-control" maxlength="5">
                        ...
                        <div class="row">
                            <div class="col-md-6 ">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="primary_contact_name" value="{{old('primary_contact_name')}}" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="primary_contact_last_name" value="{{old('primary_contact_last_name')}}" class="form-control">
...
<script type='text/javascript' src="https://rawgit.com/RobinHerbots/jquery.inputmask/3.x/dist/jquery.inputmask.bundle.js"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            //document.getElementById('AddContactPerson').checked = false;
            ...
            //document.getElementById('SignedAllDocuments').checked = true;
