                        ...
                        <div class="col-xl-6 col-xxl-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="primary_business_type_id"
                                    value="{{ old('primary_business_type_id') }}" id="PrimaryBusinessType">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="primary_contact_name"
                                    value="{{ old('primary_contact_name') }}" placeholder="{!! trans('employer.Name') !!}"
                                    class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="primary_contact_last_name"
                                    value="{{ old('primary_contact_last_name') }}" placeholder="{!! trans('employer.Last') !!}"
                                    class="form-control">
