...
class EmployerController extends Controller
{
  ...
  /*  public function profile_employer($id)
    ...
    public function store(Request $request)
    {
        ...
        $is_there_additional_worksite = $request['is_there_additional_worksite'];

        if ($is_there_additional_worksite == 'on') {
            $is_there_additional_worksite = 1;
        }else{
        ...
        if ($is_there_additional_worksite == 0) {
            if ($mailing_address_same_above == 0 && $signed_all_documents == 0 && $add_contact_person == 0) {
                ...
                $messages = [
                    ...
                    'main_worksite_state_id_id.required' => 'main_worksite_state_idd_id is required',
                    ...
                    'main_worksite_state_id_id.min' => 'Worksite State must be greater than 0 digits',
                ...
                $validated = $request->validate([
                    ...
                    'main_worksite_state_id' => 'required|min:1',
        ...
        if ($is_there_additional_worksite == 1) {
            if ($mailing_address_same_above == 0 && $signed_all_documents == 0 && $add_contact_person == 0) {
